...
$query = "select * from factions where name_faction like '%$search%'";
    ...
    while ($row = mysqli_fetch_assoc($sql)) { ?>
        ...
        <body class="preloading">
            ...
            <section class="main clearfix">
                    <div class="work">
                        <a href="faction_detail.php?id_faction=<?= $row['id_faction'] ?>">
                            <img height="406.6px" src="img/<?= $row['image_faction'] ?>" class="media" alt="" />
                            <div class="caption">
                                <div class="work_title">
                                    <h1><?= $row['name_faction'] ?></h1>
                                </div>
                            </div>
                        </a>
                    </div> 
